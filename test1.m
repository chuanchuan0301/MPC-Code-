...
fprintf('\n');
fprintf('Cloud emulation (Section 5): workers solve local NLPs in parallel;\n');
fprintf('the main process exchanges assumed neighbor trajectories (Eq. 5).\n');
fprintf('No protocol stack or communication delay is implemented.\n\n');
...
fprintf('  Event triggers: [%d, %d, %d] / %d steps\n', ...
...
fprintf('  MPC CPU: %.6f s, Feedback CPU: %.6f s, T_avg = %.6f ms/step\n\n', ...
    et_mpc_total, et_fb_total, (et_mpc_total + et_fb_total) * 1000 / T_sim);


fprintf('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
fprintf('Running Decentralized event-triggered MPC (same coupled plant, prediction ignores neighbors)...\n');
fprintf('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n');
...
fprintf('  MPC CPU: %.6f s, Feedback CPU: %.6f s, T_avg = %.6f ms/step\n\n', ...
    dist_mpc_total, dist_fb_total, (dist_mpc_total + dist_fb_total) * 1000 / T_sim);
...
fprintf('════════════════════════════════════════════════════════════════════\n');
fprintf('  Table 2  Quantitative Comparison (Section 5.1)\n');
fprintf('════════════════════════════════════════════════════════════════════\n');
fprintf('%-28s %16s %22s\n', 'Performance Metrics', 'Dis-MPC (Algorithm 1)', 'Dec-MPC');
fprintf('%-28s %16.4f %22.4f\n', 'RMSE_x', RMSEx_et, RMSEx_dist);
fprintf('%-28s %16.4f %22.4f\n', 'Tbar_Omega (s)', Tbar_omega_et, Tbar_omega_dist);
fprintf('%-28s %16.4f %22.4f\n', 'J_u', Ju_et, Ju_dist);
fprintf('\n');

for i = 1:params.M
    fprintf('  Subsystem %d: T_Omega Dis-MPC=%.2f s (step %s), Dec-MPC=%.2f s (step %s)\n', ...
